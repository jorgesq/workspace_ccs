...
main.obj: C:/work/git/umcapps/tests/umc_tesla1/main.c $(GEN_OPTS) $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: C2000 Compiler'
...
tesla.obj: C:/work/git/umcapps/tests/umc_tesla1/tesla.c $(GEN_OPTS) $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: C2000 Compiler'
	"C:/ti/ccsv6/tools/compiler/ti-cgt-c2000_6.4.10/bin/cl2000" -v28 -ml -mt --float_support=fpu32 -O2 --include_path="C:/ti/ccsv6/tools/compiler/ti-cgt-c2000_6.4.10/include" --include_path="C:/work/git/umcapps/tests/umc_tesla1/" --include_path="C:/work/git/umclib/modules/hal/boards/umc3/src/" --include_path="C:/work/git/umclib/" -g --define=FAST_ROM_V1p6 --diag_warning=225 --display_error_number --diag_wrap=off --preproc_with_compile --preproc_dependency="tesla.pp" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '
