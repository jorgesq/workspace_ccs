...
ctrlQEP.obj: C:/work/git/umclib/modules/ctrl/src/32b/ctrlQEP.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: C2000 Compiler'
...
main_ext1.obj: C:/work/git/umcapps/tests/umc_smart1/main_ext1.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: C2000 Compiler'
	"C:/ti/ccsv6/tools/compiler/c2000_15.12.3.LTS/bin/cl2000" -v28 -ml -mt --float_support=fpu32 -O2 --include_path="C:/ti/ccsv6/tools/compiler/c2000_15.12.3.LTS/include" --include_path="C:/work/git/umcapps/tests/umc_smart1/" --include_path="C:/work/git/umclib/modules/hal/boards/umc3/src/" --include_path="C:/work/git/umclib/" -g --define=FAST_ROM_V1p6 --define=ENCODER --display_error_number --diag_warning=225 --diag_wrap=off --preproc_with_compile --preproc_dependency="main_ext1.d" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '
